...
./pach.py ../xes_logs/DriversLicense.xes --smt-matrix 300  --negative ../negative_logs/DriversLicense.negatives.xes
echo '> Comienza choice.xes'
./pach.py ../xes_logs/choice.xes --smt-matrix 300  --negative ../negative_logs/choice.negatives.xes
echo '> Comienza confDimBlocking.xes'
./pach.py ../xes_logs/confDimBlocking.xes --smt-matrix 300  --negative ../negative_logs/confDimBlocking.negatives.xes
echo '> Comienza confDimStacked.xes'
./pach.py ../xes_logs/confDimStacked.xes --smt-matrix 300  --negative ../negative_logs/confDimStacked.negatives.xes

# Con poyección y/o sampling
echo ''
echo '> Comienza Con proyec y/o sampling'
echo '> Comienza incident.xes'
./pach.py ../xes_logs/incident.xes --projection --smt-matrix 300  --negative ../negative_logs/incident.negatives.xes
echo '> Comienza svn.xes'
./pach.py ../xes_logs/svn.xes --projection --smt-matrix 300  --negative ../negative_logs/svn.negatives.xes
echo '> Comienza FHMexampleN5.enc.xes'
./pach.py ../xes_logs/FHMexampleN5.enc.xes --projection --smt-matrix 300  --negative ../negative_logs/FHMexampleN5.enc.negatives.xes
echo '> Comienza receipt.xes'
./pach.py ../xes_logs/receipt.xes --projection --smt-matrix 300  --negative ../negative_logs/receipt.negatives.xes
echo '> Comienza documentflow.xes'
./pach.py ../xes_logs/documentflow.xes --projection --smt-matrix 300  --negative ../negative_logs/documentflow.negatives.xes
echo '> Comienza a32.xes'
./pach.py ../xes_logs/a32.xes --projection 8 --smt-matrix 300  --negative ../negative_logs/a32.negatives.xes
echo '> Comienza cycles5_2.xes'
./pach.py ../xes_logs/cycles5_2.xes --projection --smt-matrix 300  --negative ../negative_logs/cycles5_2.negatives.xes
