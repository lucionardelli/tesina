...
./pach.py ../xes_logs/illustrative_example.xes --smt-matrix 300 >> smt-matrix-complexities.out
echo '> Comienza running-example-just-two-cases.xes'
./pach.py ../xes_logs/running-example-just-two-cases.xes --smt-matrix 300 >> smt-matrix-complexities.out
...
#./pach.py ../xes_logs/Angiogenesis-PT-01.xes --projection 10 --sampling 5 50 --smt-matrix 300 >> smt-matrix-complexities.out
...
./pach.py ../xes_logs/t32.xes --projection 10  --smt-matrix 300 >> smt-matrix-complexities.out
