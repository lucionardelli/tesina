...
./pach.py ../xes_logs/a32.xes --projection 8 --smt-simp
#echo '> Comienza Angiogenesis-PT-01.xes'
#./pach.py ../xes_logs/Angiogenesis-PT-01.xes --projection 10 --sampling 5 50 --smt-simp
...
./pach.py ../xes_logs/cycles5_2.xes --projection 10 --smt-simp
echo '> Comienza a42.xes'
./pach.py ../xes_logs/a42.xes --projection 10 --smt-simp
echo '> Comienza t32.xes'
./pach.py ../xes_logs/t32.xes --projection 10  --smt-simp
echo '> Comienza Peterson-PT-2.xes'
./pach.py ../xes_logs/Peterson-PT-2.xes --projection 10  --smt-simp
echo '> Comienza telecom.xes'
./pach.py ../xes_logs/telecom.xes --projection --smt-simp
echo '> Comienza complex.enc.xes'
./pach.py ../xes_logs/complex.enc.xes --projection 10 --smt-simp
...
./pach.py ../xes_logs/receipt.xes --projection 10 --smt-simp
echo '> Comienza svn.xes'
./pach.py ../xes_logs/svn.xes --projection --smt-simp
mv ../xes_logs/*.pnml ../pnml/smt-matrix/
