...
./pach.py ../xes_logs/confDimBlocking.xes --smt-iter 30 >> smt-iterative-complexities.out
echo '> Comienza DriversLicense.xes'
./pach.py ../xes_logs/DriversLicense.xes --smt-iter 30 >> smt-iterative-complexities.out
echo '> Comienza confDimStacked.xes'
./pach.py ../xes_logs/confDimStacked.xes --smt-iter 30 >> smt-iterative-complexities.out

# Con poyección y/o sampling
echo ''
echo '> Comienza Con proyec y/o sampling'
echo '> Comienza log1.xes'
./pach.py ../xes_logs/log1.xes --projection 11 --smt-iter 30 >> smt-iterative-complexities.out
echo '> Comienza a32.xes'
./pach.py ../xes_logs/a32.xes --projection 8 --smt-iter 30 >> smt-iterative-complexities.out
echo '> Comienza Angiogenesis-PT-01.xes'
./pach.py ../xes_logs/Angiogenesis-PT-01.xes --projection 8 --sampling 5 500 --smt-iter 30 >> smt-iterative-complexities.out
echo '> Comienza DatabaseWithMutex-PT-02.xes'
./pach.py ../xes_logs/DatabaseWithMutex-PT-02.xes --projection --smt-iter 30 >> smt-iterative-complexities.out
...
./pach.py ../xes_logs/complex.enc.xes --projection 10 --smt-iter 30 >> smt-iterative-complexities.out
echo '> Comienza documentflow.xes'
./pach.py ../xes_logs/documentflow.xes --projection --smt-iter 30 >> smt-iterative-complexities.out
echo '> Comienza FHMexampleN5.enc.xes'
./pach.py ../xes_logs/FHMexampleN5.enc.xes --projection --smt-iter 30 >> smt-iterative-complexities.out
echo '> Comienza incident.xes'
./pach.py ../xes_logs/incident.xes --projection --smt-iter 30 >> smt-iterative-complexities.out
echo '> Comienza receipt.xes'
./pach.py ../xes_logs/receipt.xes --projection --smt-iter 30 >> smt-iterative-complexities.out
echo '> Comienza svn.xes'
./pach.py ../xes_logs/svn.xes --projection --smt-iter 30 >> smt-iterative-complexities.out
