...
./pach.py ../xes_logs/choice.xes --smt-iter 30
echo '> Comienza confDimBlocking.xes'
./pach.py ../xes_logs/confDimBlocking.xes --smt-iter 30
echo '> Comienza DriversLicense.xes'
./pach.py ../xes_logs/DriversLicense.xes --smt-iter 30
echo '> Comienza confDimStacked.xes'
./pach.py ../xes_logs/confDimStacked.xes --smt-iter 30
...
./pach.py ../xes_logs/cycles5_2.xes --projection --smt-iter 30
echo '> Comienza a42.xes'
./pach.py ../xes_logs/a42.xes --projection 10 --smt-iter 30
echo '> Comienza t32.xes'
./pach.py ../xes_logs/t32.xes --projection --smt-iter 30
echo '> Comienza Peterson-PT-2.xes'
./pach.py ../xes_logs/Peterson-PT-2.xes --projection 10 --smt-iter 30
echo '> Comienza telecom.xes'
./pach.py ../xes_logs/telecom.xes --projection --smt-iter 30
echo '> Comienza complex.enc.xes'
./pach.py ../xes_logs/complex.enc.xes --projection 8 --smt-iter 30
echo '> Comienza documentflow.xes'
./pach.py ../xes_logs/documentflow.xes --projection --smt-iter 30
echo '> Comienza FHMexampleN5.enc.xes'
./pach.py ../xes_logs/FHMexampleN5.enc.xes --projection --smt-iter 30
echo '> Comienza incident.xes'
./pach.py ../xes_logs/incident.xes --projection --smt-iter 30
echo '> Comienza receipt.xes'
./pach.py ../xes_logs/receipt.xes --projection --smt-iter 30
echo '> Comienza svn.xes'
./pach.py ../xes_logs/svn.xes --projection --smt-iter 30
