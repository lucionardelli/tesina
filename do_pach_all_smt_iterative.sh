...
./pach.py ../xes_logs/a32.xes --projection --smt-iter
...
./pach.py ../xes_logs/a42.xes --projection --smt-iter
echo '> Comienza t32.xes'
./pach.py ../xes_logs/t32.xes --projection --smt-iter
echo '> Comienza Peterson-PT-2.xes'
./pach.py ../xes_logs/Peterson-PT-2.xes --projection --smt-iter
echo '> Comienza telecom.xes'
./pach.py ../xes_logs/telecom.xes --projection --smt-iter
echo '> Comienza complex.enc.xes'
./pach.py ../xes_logs/complex.enc.xes --projection --smt-iter
