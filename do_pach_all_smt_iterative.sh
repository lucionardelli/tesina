...
./pach.py ../xes_logs/illustrative_example.xes --smt-iter
echo '> Comienza running-example-just-two-cases.xes'
./pach.py ../xes_logs/running-example-just-two-cases.xes --smt-iter
echo '> Comienza choice.xes'
./pach.py ../xes_logs/choice.xes --smt-iter
echo '> Comienza confDimBlocking.xes'
./pach.py ../xes_logs/confDimBlocking.xes --smt-iter
echo '> Comienza DriversLicense.xes'
./pach.py ../xes_logs/DriversLicense.xes --smt-iter
echo '> Comienza confDimStacked.xes'
./pach.py ../xes_logs/confDimStacked.xes --smt-iter
...
./pach.py ../xes_logs/Angiogenesis-PT-01.xes --projection 8 --sampling 5 500 --no-sanity --smt-iter
...
./pach.py ../xes_logs/cycles5_2.xes --projection --smt-iter
...
./pach.py ../xes_logs/a42.xes --projection 10 --no-sanity --smt-iter
echo '> Comienza t32.xes'
./pach.py ../xes_logs/t32.xes --projection 10  --smt-iter
echo '> Comienza t32.xes LÍMITE DE PROJ PERO SIN CHECK'
./pach.py ../xes_logs/t32.xes --projection --no-sanity --smt-iter
echo '> Comienza Peterson-PT-2.xes SIN CHECK'
./pach.py ../xes_logs/Peterson-PT-2.xes --projection 10 --no-sanity --smt-iter
...
./pach.py ../xes_logs/receipt.xes --projection --smt-iter
